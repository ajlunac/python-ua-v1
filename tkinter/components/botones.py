...
def evento4():
    boton4.config(text="Botón 4 presionado", fg="blue", relief="groove", bg="yellow")

# Uso de grid layout manager para ubicar los botones, padx y pady, ipadx, ipady, sticky, etc.
...
# Botón con el paquete de tk de Tkinter.
